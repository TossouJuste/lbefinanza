                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nom" required name="nom" placeholder="Votre nom">
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="prenom">PRENOM</label>
                                            <input type="text" class="form-control" id="prenom" required name="prenom" placeholder="Votre prénom">
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="email">EMAIL</label>
                                            <input type="email" class="form-control" id="email" required name="email" placeholder="Votre email">
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="telephone">NUMERO DE TELEPHONE</label>
                                            <input type="tel" class="form-control" id="telephone" required name="telephone" placeholder="Votre numero de télephone">
                                        </div>
                                    ...
                                    <form>
                                       ...
                                       <div class="form-group flex flex-col">
                                        ...
                                        <div class="mb-3 flex flex-row justify-between">
                                            <button class="btn bg-red-200">Precedent</button>
                                            <button class="btn btn-primary">Suivant</button>
                                        </div>
