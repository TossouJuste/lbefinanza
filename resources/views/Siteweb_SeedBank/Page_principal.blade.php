          ...
          <div class="col-lg-7">
            ...
            <div class="row pt-2 pb-4">
              <div class="col-6 col-md-4">
                <img class="img-fluid rounded" src="site_web/img/about-2.jpg" alt="" />
              </div>
        ...
        <div class="row">
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="site_web/img/class-1.jpg" alt="" />
          ...
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="site_web/img/class-2.jpg" alt="" />
              <div class="card-body text-center">
          ...
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="site_web/img/class-3.jpg" alt="" />
              <div class="card-body text-center">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            ...
            >
              <img class="img-fluid w-100" src="site_web/img/team-1.jpg" alt="" />
              <div
          ...
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            <div
              ...
              style="border-radius: 100%"
            >
              <img class="img-fluid w-100" src="site_web/img/team-2.jpg" alt="" />
              <div
                class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute"
              >
                <a
          ...
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            <div
              ...
              style="border-radius: 100%"
            >
              <img class="img-fluid w-100" src="site_web/img/team-3.jpg" alt="" />
              <div
                class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute"
              >
                <a
          ...
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            <div
              ...
              style="border-radius: 100%"
            >
              <img class="img-fluid w-100" src="site_web/img/team-4.jpg" alt="" />
              <div
                class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute"
              >
                <a
        ...
        <div class="owl-carousel testimonial-carousel">
          <div class="testimonial-item px-3">
            ...
            <div class="d-flex align-items-center">
              <img
                ...
                src="site_web/img/testimonial-1.jpg"
          ...
          <div class="testimonial-item px-3">
            ...
            <div class="d-flex align-items-center">
              <img
                class="rounded-circle"
                src="site_web/img/testimonial-2.jpg"
                style="width: 70px; height: 70px"
                alt="Image"
              />
              <div class="pl-3">
          ...
          <div class="testimonial-item px-3">
            ...
            <div class="d-flex align-items-center">
              <img
                class="rounded-circle"
                src="site_web/img/testimonial-3.jpg"
                style="width: 70px; height: 70px"
                alt="Image"
              />
              <div class="pl-3">
          ...
          <div class="testimonial-item px-3">
            ...
            <div class="d-flex align-items-center">
              <img
                class="rounded-circle"
                src="site_web/img/testimonial-4.jpg"
                style="width: 70px; height: 70px"
                alt="Image"
              />
              <div class="pl-3">
        ...
        <div class="row pb-3">
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="site_web/img/blog-1.jpg" alt="" />
          ...
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="site_web/img/blog-2.jpg" alt="" />
              <div class="card-body bg-light text-center p-4">
                <h4 class="">Diam amet eos at no eos</h4>
                <div class="d-flex justify-content-center mb-3">
                  <small class="mr-3"
          ...
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="site_web/img/blog-3.jpg" alt="" />
              <div class="card-body bg-light text-center p-4">
                <h4 class="">Diam amet eos at no eos</h4>
                <div class="d-flex justify-content-center mb-3">
                  <small class="mr-3"
