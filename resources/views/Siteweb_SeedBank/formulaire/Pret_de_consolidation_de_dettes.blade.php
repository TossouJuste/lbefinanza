    ...
    <form method="POST" >
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" id="montantDette" name="montantDette" required>
     </div>
        <div class="form-group">
            <label for="creanciers">Créanciers </label>
        <textarea id="creanciers" name="creanciers" required></textarea>

        </div>
        <div class="form-group">
            <label for="mensualiteActuelle">Mensualité actuelle </label>
            <input type="number" id="mensualiteActuelle" name="mensualiteActuelle" required>
    
        </div>
        <div class="form-group">
            <label for="montantPret">Montant du prêt de consolidation</label>
        <input type="number" id="montantPret" name="montantPret" required>
