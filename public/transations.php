              ...
              <div class="row">
                ...
                <div class="row">
                        ...
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-1 text-danger h6">Non mentionné</h3>
                           </div>
                      </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                        $transations=$db->prepare('SELECT * FROM transations WHERE id_client=?');
                        $transations->execute([$_SESSION['id_client']]);
